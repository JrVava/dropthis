...
class Browser {
	...
	public static function get_browser_icon_url( $browser = '' ) {
		...
		return self::get_browser_icon_by_name( $browser );
	...
	public static function get_browser_icon_by_name( $browser = '' ) {
		...
		return !empty($map[$browser]) ? $map[$browser] : 'default.svg';
	...
	public static function get_device_icon_url( $device = '' ) {
		return $icon = ! empty( $device ) ? strtolower( $device ) . '.svg' : 'desktop.svg';
	}
}
