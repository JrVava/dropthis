                        ...
                        <div class="row gx-2">
                            <div class="col-6">
                                <a href="javascript:;" data-toggle="theme-mode-selector" data-theme-mode="dark"
                                    class="app-theme-mode-link active" id="dark-mode">
                            ...
                            <div class="col-6">
                                <a href="javascript:;" data-toggle="theme-mode-selector" data-theme-mode="light"
                                    class="app-theme-mode-link" id="light-mode">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="app-theme-cover">
                            ...
                            @if (isset($userProfilePath))
                                <div class="app-theme-cover-item review-block" style="display:none;">
                                    <a href="javascript:;" class="app-theme-cover-link review-bg_image"
                                        style="background-image: url('{{ getFileFromStorage($userProfilePath) }}');"
