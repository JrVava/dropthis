                        ...
                        <form method="post" action="@if(Route::currentRouteName() == 'campaigns.create'){{ route('campaigns.add') }}@else{{ route('campaigns.update')}}@endif" autocomplete="off"  enctype="multipart/form-data">
                            ...
                            <div class="mb-3" id="inputFormRow">
                                <div class="card p-3">
                                    ...
                                    <div id="newRow">
                                        @if(($errors->has('track.0') || $errors->has('track_genre.0') || $errors->has('mp3_audio.0') || $errors->has('wav_audio.0')) && Route::currentRouteName() == 'campaigns.create' || (old('track') < 1  && empty($campaignTracks)))
                                        <div class="mb-3" id="inputFormRow">
                                            <div class="card p-3">
                                            <div class="form-group row mb-3">
                                        ...
                                        {{-- @if($errors->has('track'))
                                            {{ dd($errors) }}
                                        @endif --}}
                                    @if(!empty(old('track')) || !empty($campaignTracks))
                                        {{-- @for($i = 1; $i < count(old('track')); $i++) --}}
                                        @php
                                            // if(empty($campaignTracks)){
                                            // if($campaignTracks->count() == 0){
                                            //     $data = old('track', []);                                                
                                            // }else{
                                            //     $data = $campaignTracks;
                                            // }
                            ...
                            <div class="form-group row mb-3">
                                <div class="col-sm-2">
                                    <label class="form-check-label" for="expire_link_once_downloaded">Select E-Mail list group to send</label>
                                </div>
                                <div class="col-sm-10">
