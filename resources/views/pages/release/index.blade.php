...
@push('js')
    ...
    <script>
        ...
        $("body").on("click", ".release-delete-link", function(e){
            e.preventDefault();
            let text = "Are you sure you want to delete this release?";
            ...
            $("body").on("click", ".copy-btn", function(e){
                ...
                var _this = $(this);
                $(this).parent().parent().parent().parent().append('<div style="padding-left: 15px" class="text-lime">Copied!</div>');
                $temp.remove();
                setTimeout(function(){
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                   ...
                   {data: 'DT_RowIndex', name: 'DT_RowIndex'}, // DT_RowIndex is call Index Column 
                    ...
                    {data: 'total_click', name: 'total_click'},
        ...
        <div class="col-xl-12">
            <div class="d-flex align-items-center mb-md-3 mb-2">
                <div class="flex-fill">
                    ...
                    <h1 class="page-header mb-0">Releases</h1>
                </div>
                <div class="ms-auto">
                    <a href="{{ route('release.create') }}" class="btn btn-outline-theme">
            ...
            <div id="bootstrapTable" class="mb-5">
                <div class="card">
                    <div class="card-body">
                        <table id="realease-groups" class="table w-100 table-bordered table-hover data-table">
                            <thead>                                
                                <tr>
                                    <th>#</th>
                                    <th>Cover</th>
