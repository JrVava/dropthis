        ...
        <div class="col-xl-12">
            <div class="d-flex align-items-center mb-md-3 mb-2">
                <div class="flex-fill">
                    ...
                    <h1 class="page-header mb-0">Plans</h1>
                </div>
                <div class="ms-auto">
                    <a href="{{ route('plan.create') }}" class="btn btn-outline-theme">
            ...
            <div id="bootstrapTable" class="mb-5">
                <div class="card">
                    <div class="card-body">
                        <table id="plans-groups" class="table w-100 table-bordered table-hover data-table">
                            <thead>                                
                                <tr>
                                    <th>#</th>
                                    <th>Plan</th>
