...
@section('title', 'Dropthis | Release Statistics')
@push('js')
    <script>
...
@section('content')
    ...
    <div class="d-flex align-items-center mb-md-3 mb-2">
        <div class="flex-fill">
            <div class="link">
                <a title="{{ $release->label }}" href="{{ route('release.landing-page', ['key' => $release->slug]) }}"
                    class="btn text-inverse">
                    {{ $release->track }}
                </a>
                <a data-url="{{ route('release.landing-page', ['key' => $release->slug]) }}" title="Copy Short URL"
    ...
    <form method="post" id="dateFilter" action="{{ route('release.dateFilter', ['id' => $release->id]) }}">
        @csrf
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-6">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        <span class="flex-grow-1">
                            <a href="{{ route('releases') }}" class="text-inverse text-opacity-75 text-decoration-none">
                                TOTAL CLICKS
                            </a>
                        </span>
                        <a href="#" data-toggle="card-expand"
                        ...
                        <div class="col-7">
                            <h3 class="mb-0">
                                <a href="{{ route('groups') }}"
                                    ...
                                    {{ $releaseClicks->where('is_first_click', '=', 1)->count() }}
                                </a>
                            </h3>
                        </div>
                    </div>
        ...
        <div class="col-xl-6">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex fw-bold small mb-3">
                        <span class="flex-grow-1">{{ $releaseClicks->count() }} TOTAL CLICKS</span>
                        <a href="#" data-toggle="card-expand"
                            class="text-inverse text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    ...
                    <table id="clicks-details-table" class="table text-nowrap w-100" data-toggle="table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-sortable="true">Music Platform</th>
                                <th data-sortable="true">INFO</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($releaseClicks as $key => $click)
                                <tr>
                                    <td>
                                        @if (!empty($click->getCountryName()))
                                            ...
                                            @if (file_exists('countries/' . $icon))
                                                <img src="{{ asset('countries/' . $icon) }}" width="20" height="20"
                                                    title="{{ $click->getCountryName() }}">
                                            @else
                                    ...
                                    <td>
                                        <a href="{{ $click->getRelease() }}" target="_blank">
                                            <img src="{{ asset($click->music_platform) }}" width="100" height="35"
