    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <h1 class="page-header">
                Add Group <!-- <small>page header description goes here...</small> -->
            </h1>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('group.add') }}">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control plaintext" id="name" name="group" placeholder="Name" value="{{old('group')}}">
									@if ($errors->has('group'))
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10 offset-sm-2">
                                    <button type="submit" class="btn btn-outline-theme">Save Group</button>
